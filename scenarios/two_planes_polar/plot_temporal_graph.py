...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Dibuja el grafo temporal del escenario two_planes_polar usando teneto."
    )
    parser.add_argument(
        "--contact-plan",
        type=Path,
...
def main() -> None:
    ...
    title = args.title or f"Two Planes Polar Contact Plan ({args.contact_plan.stem})"
